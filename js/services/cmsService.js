// ========================================================
// SWIFLORA LOGISTICS - DUAL-SYNC CMS & CONTENT SERVICE
...
class CMSService {
  async getCMSContent(sectionId) {
    ...
    const cmsData = JSON.parse(localStorage.getItem('swf_cms') || '{}');
  ...
  async updateCMSContent(sectionId, sectionName, contentObj) {
    ...
    localStorage.setItem('swf_cms', JSON.stringify(cmsData));
