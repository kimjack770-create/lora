// ========================================================
// SWIFLORA LOGISTICS - PRINT & LABEL GENERATOR
...
export function generatePrintableShippingLabel(shipment) {
    ...
    <div class="shipping-label-card">
      <div class="label-header">
        <div class="label-brand">
          <i class="fas fa-shipping-fast" style="color: #163A58;"></i> SWIFLORA
        </div>
  ...
  if (window.QRCode) {
    new window.QRCode(modalBox.querySelector('#qrcodeCanvas'), {
      text: `https://www.swifloralogistics.com/tracking.html?tracking=${shipment.tracking_number}`,
      width: 80,
      height: 80
    });
  }
