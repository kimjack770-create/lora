-- ========================================================
-- SWIFLORA LOGISTICS - SUPABASE DATABASE SCHEMA
...
CREATE TABLE IF NOT EXISTS public.shipments (
    ...
    company_name VARCHAR(255) DEFAULT 'Swiflora Logistics',
    logistics_provider VARCHAR(100) DEFAULT 'Swiflora Express',
...
ALTER TABLE public.shipments ADD COLUMN IF NOT EXISTS company_name VARCHAR(255) DEFAULT 'Swiflora Logistics';
ALTER TABLE public.shipments ADD COLUMN IF NOT EXISTS logistics_provider VARCHAR(100) DEFAULT 'Swiflora Express';
...
CREATE TABLE IF NOT EXISTS public.blog_posts (
    ...
    content TEXT NOT NULL,
    image_url TEXT,
    author VARCHAR(100) DEFAULT 'Swiflora Team',
...
-- --------------------------------------------------------
-- 13. SEED INITIAL CMS CONTENT & SAMPLE DATA
-- --------------------------------------------------------
INSERT INTO public.cms_content (id, section_name, content) VALUES
('hero', 'Homepage Hero', '{
    "tagline": "Rooted in Reliability. Built for Speed.",
    "headline": "Grow Your Reach Across the Globe",
    "subheadline": "Track shipments in real-time, get instant freight quotes, and experience courier service rooted in reliability and built for speed.",
...
(
    'SWF-20260811-884920', 'John Harrison', '+1 202 555 0147', 'john@example.com', '1200 Pennsylvania Ave NW', 'Washington', 'United States',
    'Emma Watson', '+44 20 7946 0912', 'emma@example.co.uk', '221B Baker Street', 'London', 'United Kingdom',
    'Swiflora Logistics', 'DHL Express', 'Carton', 4.50, 1, 'Express Delivery', 'In Transit',
    'Washington, USA', 'London, UK', 'Sorting Center, Heathrow Airport, UK', 51.4700, -0.4543, '2026-08-09', '2026-08-13', 'Handle with extreme care. High priority fragile package.', 145.00, 'Paid'
),
(
    'SWF-20260811-339102', 'Global Tech Corp', '+1 415 555 0199', 'shipping@globaltech.io', '500 Howard Street', 'San Francisco', 'United States',
    'Tokyo Robotics Lab', '+81 3 5555 0143', 'import@tokyorobotics.jp', '1-1 Chiyoda', 'Tokyo', 'Japan',
    'Swiflora Logistics', 'FedEx Express', 'Box', 18.00, 2, 'Air Freight', 'Customs Clearance',
    'San Francisco, USA', 'Tokyo, Japan', 'Narita Customs Facility, Tokyo', 35.7720, 140.3929, '2026-08-08', '2026-08-14', 'Contains electronic testing equipment.', 320.00, 'Paid'
) ON CONFLICT (tracking_number) DO NOTHING;

-- Seed Testimonials
INSERT INTO public.testimonials (author_name, author_title, company, avatar_url, content, rating, is_approved) VALUES
('Amara Chen', 'Head of Supply Chain', 'Northline Retail Group', 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=150&q=80', 'Swiflora replaced two of our regional couriers. One dashboard, real-time visibility, and delivery times actually improved.', 5, true),
('Marcus Webb', 'Founder', 'Webb & Co. Imports', 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?auto=format&fit=crop&w=150&q=80', 'Customs clearance used to be our biggest bottleneck. Swiflora''s brokerage team clears our freight in a fraction of the time.', 5, true)
ON CONFLICT DO NOTHING;

-- Seed FAQs
INSERT INTO public.faqs (question, answer, sort_order) VALUES
('How do I track my shipment?', 'Enter your tracking number (e.g. SWF-20260811-884920) on the Track Package page or the homepage search bar to see live status and location history.', 1),
('What areas does Swiflora Logistics deliver to?', 'We operate air, sea, and road freight routes across 100+ countries, with express door-to-door delivery in most major metro areas.', 2),
('How is my shipping cost calculated?', 'Rates are based on weight, dimensions, service type (Road, Air, Sea, or Express), and destination. Use the Get a Quote page for an instant estimate.', 3),
('Can I get customs clearance handled for me?', 'Yes. Our brokerage team manages import/export documentation, duty calculation, and customs clearance on your behalf for international shipments.', 4),
('How do I book a shipment or request a pickup?', 'Submit a quote request, or contact our support line at +1 364 547 2182 and our dispatch team will schedule a pickup.', 5)
ON CONFLICT DO NOTHING;
